...
- Architecture contract is defined in `.claude/rules/architecture.md`
...
6. **Architecture validation** — Read `.claude/rules/architecture.md`, then for each script use `read_file` to inspect it against the contract.
